...
const ContactoPage = () => {
  ...
  return (
    <div className='flex flex-col justify-center'>
        ...
        <section className='flex flex-col justify-center xl:flex xl:flex-row xl:px-24 xl:py-24'>
            <video className='w-48 xl:w-96 shadowBox rounded-lg '  muted controls src="/assets/vid-contacto.mp4" alt="" />
            <aside className=' flex flex-col justify-center items-center gap-12'>
